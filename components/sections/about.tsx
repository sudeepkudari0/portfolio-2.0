      ...
      <div className="max-w-4xl px-8">
        ...
        <div className="space-y-6 text-lg md:text-xl text-zinc-300">
          ...
          <p className="leading-relaxed">
            ...
            modern web technologies. My passion lies in transforming complex
            challenges into elegant, user-friendly applications that make a real
            impact.
          </p>

          <p className="leading-relaxed">
            As an <span className="text-white font-medium">ISE&apos;23</span>{" "}
            graduate, I&apos;m constantly pushing the boundaries of what&apos;s
            possible with technology. Currently, I&apos;m exploring{" "}
            <span className="text-white font-medium">Kubernetes</span>,{" "}
            <span className="text-white font-medium">Go</span>, and{" "}
            <span className="text-white font-medium">GraphQL</span> to expand my
            skill set and stay at the forefront of modern development practices.
          </p>
