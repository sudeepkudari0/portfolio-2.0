      ...
      <div className="flex-1 flex items-center overflow-hidden">
        <div ref={scrollRef} className="flex gap-6 px-8 will-change-transform">
          {projects.map((project, index) => (
            <div
              key={index}
              className="shrink-0 w-[85vw] sm:w-[65vw] md:w-[50vw] lg:w-xl border border-slate-700 rounded-2xl p-6 hover:bg-slate-800/50 transition-colors cursor-pointer bg-slate-900/50 backdrop-blur-sm"
            >
